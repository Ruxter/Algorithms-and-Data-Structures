	...
	namespace DataStructures
	{
		namespace ArrayBasedStructures
		{
			namespace Procedural
			{
				...
				/**
				 * \brief Struktura reprezentující poloku v seznamu {@link #ADSLibrary::DataStructures::ArrayBasedStructures::Procedural::List}
				 */
				struct ListItem
				{
					/**
					...
					int Value;
					/**
					 * Ukazatel na pøedchozí poloku. Pokud taková poloka neexistuje ukazatel má hodnotu {@link #Nil}.
					 */
					int Prev;
					/**
					 * Ukazatel na následující  poloku. Pokud taková poloka neexistuje ukazatel má hodnotu {@link #Nil}.
					 */
					int Next;
				};
				 ...
				 *
				 * @author	Jiøí Dvorskı <jiri.dvorsky@vsb.cz>
				 * @date	2010 - 2015
				 */
				struct List
				{
					...
					/**
					 * Hlava seznamu tj. ukazatel na první poloku seznamu v poli {@link #Data}.
					 */
					int Head;
					/**
					 * Ukazatel na první volnou poloku v poli {@link #Data}. Pokud taková poloka neexistuje, má ukazatel hodnotu Nil.
