...
/*
* Soubor slouûÌcÌ k testov·nÌ LinkedStructures (OOP, OOPTemplate, Procedural)
* T¯Ìdy List a DoublyLinkedList ze jmennÈho prostoru OOPTemplate jsou testov·ny zvl·öù
* 
* BST v LinkedStructures se liöÌ od implementace BST v CollectionsGenerics. Bylo pot¯eba p¯izp˘sobit strukturu pro pot¯eby mnoûiny a slovnÌku.
*/

/*
* Pomocn· struktura pro testov·nÌ
*/
